...
//go:generate mockgen -destination=$PWD/internal/mock/providers/providers_mock.go https://github.com/repofuel/repofuel-ingest/pkg/providers SourceIntegration
...
import (
	...
	"https://github.com/repofuel/repofuel-ingest/pkg/providers"
)
